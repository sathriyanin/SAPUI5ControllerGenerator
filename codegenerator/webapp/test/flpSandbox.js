		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Control Code Generator ",
									"targetURL": "#ControlCodeGenerator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ControlCodeGenerator-display": {
								"semanticObject": "ControlCodeGenerator",
								"action": "display",
								"description": "A Fiori application for Siva",
								"title": "Control Code Generator ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.siva.app.codegenerator",
									"url": sap.ui.require.toUrl("com/siva/app/codegenerator")
								}
							}
						}
					}
