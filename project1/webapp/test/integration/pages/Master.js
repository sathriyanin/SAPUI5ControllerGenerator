		...
		onTheMasterPage : {
			...
			actions : {
				...
				iSortTheListOnUnitNumber : function () {
					return this.iChooseASorter("sortButton", "Sort By <SupplierID>");
				},

				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<SupplierID>", "<100 <UnitPrice>");
				},

				iGroupTheList : function () {
					return this.iChooseASorter("groupButton", "<SupplierID> Group");
				},
			...
			assertions : {
				...
				theListShouldBeFilteredOnUnitNumber : function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("SupplierID", 100);
				},
